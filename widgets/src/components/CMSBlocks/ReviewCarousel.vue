<template>
  <div 
    ref="wrapper"
    class="ReviewCarouselWrapper" 
    :style="{ '--bg-color': backgroundColor }"
  >
    <div class="--custom-container">
      <div class="BannerReviewCarousel">
        <slider
        ...
        >
          ...
          >
            ...
            >
              <h5>{{ slide.titleCopy }}</h5>
              <div class="Review__rating clearfix">
                <i
                  v-for="i in slide.starCount"
                  :key="i.$id"
                >
                  <svg
              ...
              <div class="Review__author">
                ...
                <span>{{ slide.reviewerAddress }}</span>
              </div>
              <a
                :href="slide.linkUrl"
                class="--caps"
...
export default {
  ...
  props: {
    backgroundColor: { type: String, default: '#e8e6e2' },
  ...
  mounted() {
    ...
    const to = { opacity: 1, y: 0, force3D: true };
    const controller = new ScrollMagic.Controller();
    const reviewSet = TweenMax.staggerFromTo(this.$refs.images, 0.9, from, to, 0.2);
    ...
    const reviewContentSet = TweenMax.staggerFromTo(this.$refs.content, 0.9, from, to, 0.2);
    new ScrollMagic.Scene({
      triggerElement: '.ReviewCarouselWrapper',
      reverse: false,
      triggerHook: 'onEnter',
